<header class="main-header">
  ...
  <a href="{{ route('dashboard') }}" class="logo">
    ...
    <span class="logo-mini"><b>@if(isset($siteName)){{ strtoupper( substr($siteName, 0, 3) ) }}@endif</b></span>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                ...
                <small><strong>{{ \App\Models\Roles::find(Auth::user()->role_id)->role_name }}</strong></small>
              </p>
            </li>
            <!-- Menu Body -->
            <!--li class="user-body">
